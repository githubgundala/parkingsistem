            ...
            <div class="row mt-5">
                <div class="col">
                    ...
                    <a
                        ...
                        class="ml-1 underline text-muted fs-6"
                        >Shop</a
                    >
                    ...
                    <svg
                        ...
                        stroke-width="2"
                        viewBox="0 0 24 24"
                        class="d-inline ms-4 w-5 text-muted"
                    >
                        <path
...
export default {
    ...
    mounted() {
        console.log("run");
        document.body.addClass("hold-transition sidebar-mini layout-fixed");
    },
};
</script>
