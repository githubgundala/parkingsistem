            ...
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="/checkout_parking" enctype="multipart/form-data">
                        ...
                        <textarea class="btn btn-primary btn-sm" id="cam-qr-result" required="required" name="qrcode"
                            required
                            style="border:none;height:24px; outline:none; resize:none; overflow:hidden;"></textarea>
            ...
            <div class="card">
                ...
                <div class="body">
                    <form method="post" action="{{ route('transaksi.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" autocomplete="off" required
                                    placeholder="No-Plat" name="no_plat" />
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                            ...
                            <select class="form-control show-tick" required name="kategori" id="kategori">
                                ...
                                <option value="{{ $row->get_kategori->kategori_id }} - {{ $row->harga }}">
                                    {{ $row->get_kategori->kendaraan }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="Submit" class="btn btn-info waves-effect" data-toggle="modal"
